...
int main() {
    ...
    const double monthlyInterestRate =
                 BankAccount::ANNUAL_INTEREST_RATE / 12.0;
    ...
    std::cout << std::endl << std::endl << "Testing SavingsAccount " << std::endl;
    ...
    std::cout << "    Savings Account withdraw " << withdrawFromSavings << ", current balance: "
    ...
    std::cout << "    Savings Account withdrawals " << savingsAccount->getNumberOfWithdrawals()
    << std::endl;
    
    std::cout << "7. Testing  number of deposits " << std::endl;
    std::cout << "    Savings Account deposits " << savingsAccount->getNumberOfDeposits()
    << std::endl;
    ...
    std::cout << "    Savings Account deposits "
              << savingsAccount->getNumberOfDeposits()
    << std::endl;
